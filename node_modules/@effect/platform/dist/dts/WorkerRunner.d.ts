...
export declare namespace SerializedRunner {
    ...
    type Handlers<A extends Schema.TaggedRequest.All> = {
        readonly [K in A["_tag"]]: Extract<A, {
            readonly _tag: K;
        }> extends Schema.SerializableWithResult<infer S, infer _SI, infer _SR, infer A, infer _AI, infer E, infer _EI, infer _RR> ? (_: S) => Stream.Stream<A, E, any> | Effect.Effect<A, E, any> | Layer.Layer<any, E, any> | Layer.Layer<never, E, any> : never;
    };
    /**
     * @since 1.0.0
     */
