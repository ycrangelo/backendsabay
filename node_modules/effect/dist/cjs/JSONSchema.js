...
const isContentSchemaSupported = options => options.target !== "jsonSchema7";
const isNullTypeKeywordSupported = options => options.target !== "openApi3.1";
// https://swagger.io/docs/specification/v3_0/data-models/data-types/#null
const isNullableKeywordSupported = options => options.target === "openApi3.1";
